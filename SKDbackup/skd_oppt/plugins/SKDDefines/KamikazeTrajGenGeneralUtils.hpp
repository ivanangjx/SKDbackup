...
public:
    ...
    static void addGeneralPluginOptions(options::OptionParser* parser) {
        ...
        parser->addOption<FloatType>("problem",
                                    "discountFactor",
                                    &KamikazeTrajGenGeneralOptions::discountFactor);
        ...
        parser->addOption<FloatType>("transitionPluginOptions",
                                         "accelerationError",
                                         &KamikazeTrajGenGeneralOptions::accelerationError);

        parser->addOption<FloatType>("transitionPluginOptions",
                                         "velocityError",
                                         &KamikazeTrajGenGeneralOptions::velocityError);
