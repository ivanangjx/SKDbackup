...
public:
    ...
    virtual FloatType getMaxConstraintUsingST(const HeuristicInfo* heuristicInfo) {return 0;}
    virtual FloatType getMinConstraintUsingST(const HeuristicInfo* heuristicInfo) {return 0;}

    virtual FloatType getMaxConstraintRefine(const HeuristicInfo* heuristicInfo) {return 0;}
    virtual FloatType getMinConstraintRefine(const HeuristicInfo* heuristicInfo) {return 0;}

    virtual std::vector<float> getConstraintVectorUsingST(const HeuristicInfo* heuristicInfo) {return {};}
