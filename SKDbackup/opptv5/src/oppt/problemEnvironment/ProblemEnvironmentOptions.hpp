...
struct ProblemEnvironmentOptions : public oppt::Options {
    ...
    FloatType safetyGoal = 0.0;
    FloatType fixedStepTime = 0.0;
    FloatType brakingDeceleration = 0.0;
    FloatType fixedVelocity = 0.0;
    bool resetTreeAfterEachRun = true;
    ...
    static void addGeneralOptions(options::OptionParser* parser) {
        ...
        // Ivan ADDED START ************
        parser->addOptionWithDefault<FloatType>("constraintOptions", "safetyGoal", &ProblemEnvironmentOptions::safetyGoal, 0.0);

        parser->addOptionWithDefault<FloatType>("transitionPluginOptions", "fixedStepTime", &ProblemEnvironmentOptions::fixedStepTime, 0.0);

        parser->addOptionWithDefault<FloatType>("generalOptions", "brakingDeceleration", &ProblemEnvironmentOptions::brakingDeceleration, 0.0);

        parser->addOptionWithDefault<FloatType>("generalOptions", "fixedVelocity", &ProblemEnvironmentOptions::fixedVelocity, 0.0);

        parser->addOptionWithDefault<bool>("ABT", "resetTreeAfterEachRun", &ProblemEnvironmentOptions::resetTreeAfterEachRun, true);
